package net.mcreator.ageofshinobiaddon.procedures;
...
public class ProcedureUtils extends ElementsAgeofshinobiaddonMod.ModElement {
    ...
    public ProcedureUtils(ElementsAgeofshinobiaddonMod instance) {
        super(instance, 177);
    }
