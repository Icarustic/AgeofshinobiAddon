...
public class ItemSummoningContract extends ElementsAgeofshinobiaddonMod.ModElement {
    ...
    public void initElements() {
        ...
        elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityGenericToad.class)
                .id(new ResourceLocation("ElementsAgeofshinobiaddonMod", "toad_summon"), ENTITYID).name("toad_summon").tracker(96, 3, true).egg(-1, -1).build());
        elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityGenericSnake.class)
                .id(new ResourceLocation("ElementsAgeofshinobiaddonMod", "snake_summon"), ENTITY2ID).name("snake_summon").tracker(96, 3, true).egg(-1, -1).build());
    }

    @SideOnly(Side.CLIENT)
    @Override
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("ElementsAgeofshinobiaddonMod:summoning_contract", "inventory"));
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityGenericToad.class, renderManager -> {
            return new EntityToad.RenderCustom<EntityGenericToad>(renderManager, new EntityToad.ModelToad()) {
                private final ResourceLocation texture = new ResourceLocation("ElementsAgeofshinobiaddonMod:textures/toad1.png");
                @Override
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityGenericSnake.class, renderManager -> {
            return new EntitySnake.RenderSnake<EntityGenericSnake>(renderManager) {
                private final ResourceLocation texture1 = new ResourceLocation("ElementsAgeofshinobiaddonMod:textures/snake_white.png");
                private final ResourceLocation texture2 = new ResourceLocation("ElementsAgeofshinobiaddonMod:textures/snake_blue.png");
                @Override
        ...
        public static class Jutsu implements ItemJutsu.IJutsuCallback {
            ...
            public boolean createJutsu(ItemStack stack, EntityLivingBase entity, float power) {
                ...
                entity.world.playSound(null, entity.posX, entity.posY, entity.posZ,
                        net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("ElementsAgeofshinobiaddonMod:kuchiyosenojutsu")),
