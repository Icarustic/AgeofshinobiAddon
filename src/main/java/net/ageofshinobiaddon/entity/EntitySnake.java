package net.ageofshinobiaddon.entity;
...
public class EntitySnake extends ElementsAgeofshinobiaddonMod.ModElement {
    public EntitySnake(ElementsAgeofshinobiaddonMod instance) {
        super(instance, 686);
    }
